...
public class XsdMapConfig {
	...
	static {
		javaName2Method.put("java.math.BigDecimal", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getBigDecimal");
		javaName2Method.put("java.math.BigInteger", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getBigInteger");
		javaName2Method.put("java.lang.Boolean", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getBoolean");
		javaName2Method.put("java.lang.Byte", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getByte");
		javaName2Method.put("java.lang.Character", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getCharacter");
		javaName2Method.put("java.lang.Double", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getDouble");
		javaName2Method.put("java.lang.Float", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getFloat");
		javaName2Method.put("java.lang.Integer", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getInteger");
		javaName2Method.put("java.lang.Long", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getLong");
		javaName2Method.put("java.lang.Short", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getShort");
		javaName2Method.put("java.lang.String", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getString");
		javaName2Method.put("java.util.Calendar", "de.incunabulum.owl2java.core.model.xsd.XsdUtils.getCalendar");
		javaName2Method.put("com.hp.hpl.jena.datatypes.xsd.XSDDuration",
				"de.incunabulum.owl2java.core.model.xsd.XsdUtils.getXSDDuration");
		javaName2Method.put("com.hp.hpl.jena.datatypes.xsd.XSDDateTime",
				"de.incunabulum.owl2java.core.model.xsd.XsdUtils.getXSDDateTime");
	}
